...
| Table | Count | Notes |
|-------|-------|-------|
| `startups` | 272 | **all scored** (analyse-45 Snyk→Contextual) |
| `analysed` (cohort) | 272 | CANONICAL **30/30** |
| `wedges` | 5440 | **272 primary** (selected=1) + shortlists |
| `infrastructure_ops` | ~1275 | post analyse-45 |
...
| `candidate_startups` | 285 | pending **13** |
| `personal_fit` | 272 | all e2e |
