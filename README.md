...
| Table | Count | Notes |
|-------|-------|-------|
| `startups` | 366 | **all scored** (analyse-64 Five9→Hyperbrowser + cluster) |
| `analysed` (cohort) | 366 | CANONICAL **32/32** |
| `wedges` | 7320 | **366 primary** + shortlists |
...
- **Done (pushed):** CANONICAL **32/32**; e2e **366/366**; wedges **7320**; patterns **74**. Latest: **ingest+analyse-64** Five9/LocalAI/Superwise/Evidence/Hyperbrowser + **cluster** (+5). next **ingest**. **90 tests green.**
