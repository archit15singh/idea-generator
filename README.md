...
| Table | Count | Notes |
|-------|-------|-------|
| `startups` | 277 | **all scored** (analyse-46 Seven→Nomic + candidate expand) |
| `analysed` (cohort) | 277 | CANONICAL **30/30** |
| `wedges` | 5540 | **277 primary** (selected=1) + shortlists |
| `infrastructure_ops` | ~1300 | post analyse-46 |
...
| `candidate_startups` | 304 | pending **27** |
| `personal_fit` | 277 | all e2e |
