...
| Table | Count | Notes |
|-------|-------|-------|
| `startups` | 326 | **all scored** (analyse-56 Copilot→Bump + cluster) |
| `analysed` (cohort) | 326 | CANONICAL **32/32** |
| `wedges` | 6520 | **326 primary** + shortlists |
...
| `candidate_startups` | 451 | pending **129** |
| `personal_fit` | 326 | all e2e |
...
- **Done (pushed):** CANONICAL **32/32**; e2e **326/326**; wedges **6520**; personal_fit **326**; patterns **49**. Latest: **ingest+analyse-56** Copilot/Voiceflow/Dify/Cohere/Bump + **cluster** (+5). next **ingest**. **90 tests green.**
- **Next fire:** `ingest` Codeium / Intercom Fin / FastGPT… (plan) → analyse→score→select.
