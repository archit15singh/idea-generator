...
| Table | Count | Notes |
|-------|-------|-------|
| `startups` | 162 | **157 scored** + **5 ingested** (ids 166–170) |
| `analysed` (cohort) | 157 | ingest-23 backlog awaiting analyse |
...
**`plan_recursive_fanout` next_action = `analyse`**. Ingest-23: Paubox (#166), Decagon (#167), Pilot (#168), Feedzai (#169), WarpStream (#170). Railway skipped (dupe #21). Primary mix Better memory 48, Better evaluation 44, AI-native 23, Developer-first 23.
...
- **Done (pushed):** CANONICAL **27/27** analysed; e2e **153/157** full (4 thin-evidence legacy); wedges 3140; personal_fit 157; **157 primary**; **patterns 18**; startups **162**. Latest: **ingest-23** — Paubox, Decagon, Pilot, Feedzai, WarpStream → ingested (Railway dupe skipped). next **analyse**. **88 tests green.**
- **Next fire:** `analyse` ids 166–170 then score/select.
...
1. **Analyse** ids 166–170 then score/select.
