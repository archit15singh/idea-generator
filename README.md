...
| Table | Count | Notes |
|-------|-------|-------|
| `startups` | 391 | **all scored** (analyse-69 Cartesia→E2B + cluster) |
| `analysed` (cohort) | 391 | CANONICAL **32/32** |
| `wedges` | 7820 | **391 primary** + shortlists |
...
- **Done (pushed):** CANONICAL **32/32**; e2e **391/391**; wedges **7820**; patterns **99**. Latest: **ingest+analyse-69** Cartesia/Confident/Rippling/Gretel/E2B + **cluster** (+5). next **ingest**. **90 tests green.**
