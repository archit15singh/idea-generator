...
After 8 weeks of runtime, **≥1 wedge must have 3+ prospect replies indicating real pain**. If not, wedge-selection is broken; stop and re-tune `personalisation-and-founder-history.md` before resuming. Without this, the agent optimizes throughput, not learning.