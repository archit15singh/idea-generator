...
**Live snapshot (post ingest+analyse-61 + cluster):** startups=**351** scored | wedges=**7020** | primary=**351** | personal_fit=**351** | patterns=**59** | CANONICAL=**32/32** | e2e=351/351 | next=**ingest** | wave #356–360 Devin/Botpress/Ragflow/Beam/Gravitee — Faster / Better integrations / Self-hosted / Cheaper / Compliance-first | +5 patterns | pending **122** | tests=**90** green.
