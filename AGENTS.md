...
**Live snapshot (post analyse-22 E2E):** startups=157 scored | wedges=3140 | primary=157 | personal_fit=157 | patterns=18 | segments=123 | candidates=277 | CANONICAL=**27/27** analysed | e2e=153/157 | convergent=4 | top_infra=Tracing/observability | next_action=**ingest** | primary Better memory 48 / Better evaluation 44 / AI-native 23 / Developer-first 23 | primaries: Protect AI=AI-native, Egress=AI-native, Sierra=Better memory, Artisan=Better memory, Martian=Developer-first | tests=88 green.
