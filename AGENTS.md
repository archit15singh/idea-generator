...
**Live snapshot (post cluster):** startups=87 all scored | wedges=1740 | primary=87 | personal_fit=87 | infra_ops=433 | patterns=13 | convergent=4 (Connectors/Cost/Auth/Tracing) | segments=102 | CANONICAL=20/20 | next_action=**ingest** | tests=88 green.
