...
**Live snapshot (post analyse-21):** startups=147 scored E2E | wedges=2940 | primary=147 | personal_fit=147 | patterns=16 | segments=123 | candidates=277 | CANONICAL=**27/27** analysed | e2e=147/147 | convergent=4 | next_action=**cluster** (+20 new) | primary Better memory 45 / Better evaluation 42 / Developer-first 22 / AI-native 20 | tests=88 green.
