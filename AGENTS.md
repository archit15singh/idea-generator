...
**Live snapshot (post score_a+select 101–105):** startups=97 scored | wedges=1940 | primary=97 | personal_fit=97 | patterns=13 | segments=102 | CANONICAL=20/20 | e2e=97/97 | next_action=**ingest** | tests=88 green.
