...
**Live snapshot (post analyse-26 E2E):** startups=**177** scored | wedges=**3540** | primary=**177** | personal_fit=**177** | patterns=20 | segments=123 | candidates=277 | CANONICAL=**27/27** analysed | e2e=177/177 | convergent=4 | top_infra=Tracing/observability | next_action=**ingest** | primary Better memory 50 / Better evaluation 47 / Developer-first 28 / AI-native 26 | primaries: Trustpair=AI-native, AirOps=Better memory, Rootly=Better memory, WorkOS=Developer-first, Langfuse=Better evaluation | tests=88 green.
