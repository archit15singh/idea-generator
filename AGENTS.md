...
**Live snapshot (post score_a+select 96–100):** startups=92 all scored | wedges=1840 | primary=92 | personal_fit=92 | infra_ops=454 | patterns=13 | segments=102 | CANONICAL=20/20 | next_action=**ingest** | tests=88 green.
