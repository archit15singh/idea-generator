...
**Live snapshot (post ingest-13):** startups=112 (107 scored + 5 ingested) | wedges=2140 | primary=107 | personal_fit=107 | patterns=15 | segments=114 | CANONICAL=24/24 | e2e=107/112 | convergent=4 | next_action=**analyse** (Poolside/Stainless/Cognee/Deel/Decodable) | tests=88 green.
