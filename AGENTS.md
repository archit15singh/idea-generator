...
**Live snapshot (post analyse-23 E2E):** startups=162 scored | wedges=3240 | primary=162 | personal_fit=162 | patterns=18 | segments=123 | candidates=277 | CANONICAL=**27/27** analysed | e2e=158/162 | convergent=4 | top_infra=Tracing/observability | next_action=**ingest** | primary Better memory 48 / Better evaluation 45 / Developer-first 24 / AI-native 23 | primaries: Paubox=API-first, Decagon=Better evaluation, Pilot=Cheaper, Feedzai=More accurate, WarpStream=Developer-first | tests=88 green.
