...
**Live snapshot (post ingest-16):** startups=127 (122 scored + 5 ingested) | wedges=2440 | primary=122 | personal_fit=122 | patterns=15 | segments=114 | CANONICAL=24/24 | e2e=122/122 | convergent=4 | next_action=**analyse** (ids 131–135) | tests=88 green.
