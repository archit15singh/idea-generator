...
**Live snapshot (post ingest-19):** startups=142 (137 scored + 5 ingested) | wedges=2740 | primary=137 | personal_fit=137 | patterns=16 | segments=123 | candidates=277 | CANONICAL=**27** (24 analysed; 3 new pending analyse) | e2e=137/137 | convergent=4 | next_action=**analyse** (ids 146–150 Guardrails/Adept/OpenRouter/Convex/Postmark) | primary Better memory 42 / Better evaluation 39 / AI-native 20 | tests=88 green.
