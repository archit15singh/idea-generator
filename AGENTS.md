...
**Live snapshot (post analyse-15):** startups=122 (117 scored + 5 analysed) | wedges=2440 | primary=117 | personal_fit=117 | patterns=15 | segments=114 | CANONICAL=24/24 | e2e=117/117 | convergent=4 | next_action=**score_a** (ids 126–130) | tests=88 green.
