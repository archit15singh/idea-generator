...
**Live snapshot (post score_a-13):** startups=112 scored | wedges=2240 | primary=107 | personal_fit=112 | patterns=15 | segments=114 | CANONICAL=24/24 | e2e=107/112 (select_pending=5) | convergent=4 | next_action=**select** (ids 116–120) | tests=88 green.
