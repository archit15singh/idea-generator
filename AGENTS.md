...
**Live snapshot (post ingest-25):** startups=172 (167 scored + 5 ingested) | wedges=3340 | primary=167 | personal_fit=167 | patterns=20 | segments=123 | candidates=277 | CANONICAL=**27/27** analysed | e2e=163/167 | convergent=4 | top_infra=Tracing/observability | next_action=**analyse** (ids 176–180 Mimecast/Gumloop/Zeni/Cerbos/Confluent) | primary Better memory 48 / Better evaluation 46 / Developer-first 25 | tests=88 green.
