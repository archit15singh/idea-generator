...
**Board snapshot (Aug 07 2026, after analyse-13):** startups=112 (107 scored + 5 analysed) | wedges=2240 | primary=107 | personal_fit=107 | patterns=15 | segments=114 | candidates=266 | CANONICAL 24/24 | e2e=107/112 | convergent=4 (Connectors/Cost/Auth/Tracing) | next=`score_a` (ids 116–120) | tests=88.
