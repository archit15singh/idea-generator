...
**Board snapshot (Aug 07 2026, after analyse-25 E2E):** startups=172 scored | wedges=3440 | primary=172 | personal_fit=172 | patterns=20 | segments=123 | candidates=277 | CANONICAL **27/27** analysed | e2e=168/172 | convergent=4 | top_infra=Tracing/observability | next=`ingest` | primary mix Better memory 48 / Better evaluation 46 / Developer-first 27 / AI-native 25 | primaries 176 AI-native / 177 Developer-first / 178 Cheaper / 179 Open source / 180 Developer-first | tests=88.
