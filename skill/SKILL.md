...
**Board snapshot (Aug 07 2026, after analyse-30 E2E):** startups=**197** scored | wedges=**3940** | primary=**197** | personal_fit=**197** | patterns=**23** | segments=**132** | CANONICAL **30/30** | e2e=197/197 | convergent=5 | next=`ingest` | primary mix Better memory 56 / Better evaluation 51 / Developer-first 33 / AI-native 31 | primaries 201 Developer-first / 202 Better memory / 203 AI-native / 204 AI-native / 205 Developer-first | tests=88.
