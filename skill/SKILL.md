...
**Board snapshot (Aug 07 2026, after ingest+analyse-73 + cluster):** startups=**411** scored | wedges=**8220** | primary=**411** | personal_fit=**411** | patterns=**119** | CANONICAL **32/32** | e2e=411/411 | next=`ingest` | wave Mosaic/Lever/StackBlitz/BrowserCo/CoCounsel + cluster (+5) | pending **61** | tests=**91**.
