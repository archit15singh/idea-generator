...
**Board snapshot (Aug 07 2026, after analyse-23 E2E):** startups=162 scored | wedges=3240 | primary=162 | personal_fit=162 | patterns=18 | segments=123 | candidates=277 | CANONICAL **27/27** analysed | e2e=158/162 | convergent=4 | top_infra=Tracing/observability | next=`ingest` | primary mix Better memory 48 / Better evaluation 45 / Developer-first 24 / AI-native 23 | primaries 166 API-first / 167 Better evaluation / 168 Cheaper / 169 More accurate / 170 Developer-first | tests=88.
