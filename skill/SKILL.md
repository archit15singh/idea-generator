...
**Board snapshot (Aug 07 2026, after analyse 111–115):** startups=107 (102 scored + 5 analysed) | wedges=2140 | primary=102 | personal_fit=102 | patterns=13 | segments=114 | candidates=266 | CANONICAL 24/24 | clusterer ready | next=`score_a` [111–115] | tests=88.
