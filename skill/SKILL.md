...
**Board snapshot (Aug 07 2026, after cluster):** startups=127 scored | wedges=2540 | primary=127 | personal_fit=127 | patterns=16 | segments=114 | candidates=266 | CANONICAL 24/24 | e2e=127/127 | convergent=4 (Connectors 115/Cost 89/Tracing 87/Auth 81) | next=`ingest` | primary mix Better memory 38 / Better evaluation 36 / AI-native 20 | +pattern Agent browser/computer-use | tests=88.
