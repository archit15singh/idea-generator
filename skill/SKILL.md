...
**Board snapshot (Aug 07 2026, after score_a-15):** startups=122 scored | wedges=2440 | primary=117 | personal_fit=122 | patterns=15 | segments=114 | candidates=266 | CANONICAL 24/24 | e2e=117/122 | convergent=4 (Connectors/Cost/Auth/Tracing) | next=`select` (126–130) | primary mix Better memory 34 / Better evaluation 32 / AI-native 18 | fit tops Sublime=65 Composio=60 | tests=88.
