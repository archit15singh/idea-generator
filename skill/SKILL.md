...
**Board snapshot (Aug 07 2026, after cluster):** startups=107 scored | wedges=2140 | primary=107 | personal_fit=107 | patterns=15 | segments=114 | candidates=266 | CANONICAL 24/24 | e2e=107/107 | convergent=4 (Connectors/Cost/Auth/Tracing) | next=`ingest` | tests=88.
