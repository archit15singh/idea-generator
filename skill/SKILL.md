...
**Board snapshot (Aug 07 2026, after ingest+analyse-72 + cluster):** startups=**406** scored | wedges=**8120** | primary=**406** | personal_fit=**406** | patterns=**114** | CANONICAL **32/32** | e2e=406/406 | next=`ingest` | wave AI21/Greenhouse/Deepnote/Codesandbox/Novu + cluster (+5) | pending **67** | tests=**90**.
