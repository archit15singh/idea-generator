...
**Board snapshot (Aug 07 2026, after score_a-14):** startups=117 scored | wedges=2340 | primary=112 | personal_fit=117 | patterns=15 | segments=114 | candidates=266 | CANONICAL 24/24 | e2e=112/117 select_pending=5 | convergent=4 (Connectors/Cost/Auth/Tracing) | next=`select` (ids 121–125) | tests=88.
