...
**Board snapshot (Aug 07 2026, after score_a+select 91–95):** startups=87 all scored | wedges=1740 | primary=87 | personal_fit=87 | infra_ops=433 | segments=102 | candidates=251 | CANONICAL 20/20 | next=`cluster` | tests=88.
