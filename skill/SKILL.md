...
**Board snapshot (Aug 07 2026, after ingest-31):** startups=**202** (197 scored + 5 ingested) | wedges=**3940** | primary=**197** | personal_fit=**197** | patterns=**23** | segments=**132** | CANONICAL **30/30** | e2e=197/202 | convergent=5 | next=`analyse` | primary mix Better memory 56 / Better evaluation 51 / Developer-first 33 / AI-native 31 | backlog 206–210 Turso/Descope/Otter/Chroma/Hebbia | tests=88.
