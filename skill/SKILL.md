...
**Board snapshot (Aug 07 2026, after ingest-17):** startups=132 (127 scored + 5 ingested) | wedges=2540 | primary=127 | personal_fit=127 | patterns=16 | segments=114 | candidates=266 | CANONICAL 24/24 | e2e=127/127 | convergent=4 | next=`analyse` (Anomalo/Supabase/Valimail/Langdock/Skyvern 136–140) | primary mix Better memory 38 / Better evaluation 36 / AI-native 20 | tests=88.
