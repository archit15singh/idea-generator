...
**Board snapshot (Aug 07 2026, after ingest-18):** startups=137 (132 scored + 5 ingested) | wedges=2640 | primary=132 | personal_fit=132 | patterns=16 | segments=114 | candidates=266 | CANONICAL 24/24 | e2e=132/132 | convergent=4 | next=`analyse` (Neon/EasyDMARC/Harvey/Reworkd/Sardine 141–145) | primary mix Better memory 40 / Better evaluation 37 / AI-native 20 / Developer-first 17 | tests=88.
