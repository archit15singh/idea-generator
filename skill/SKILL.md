...
**Board snapshot (Aug 07 2026, after ingest+analyse-58):** startups=**336** scored | wedges=**6720** | primary=**336** | personal_fit=**336** | patterns=**49** | CANONICAL **32/32** | e2e=336/336 | next=`ingest` | wave JetBrains/Cognigy/AnythingLLM/Cerebras/Redocly | pending **130** | tests=**90**.
